...
import { Copy, Eye, Star, TrendingUp, Zap } from "lucide-react";
								...
								<div className="flex items-start justify-between gap-4 mb-4">
									...
									{prompt.categories && (
										<Badge
											...
											style={{
												backgroundColor:
													prompt.categories.color + "15",
												color: prompt.categories.color,
												borderColor:
													prompt.categories.color + "40",
											}}
										>
						...
						<div className="space-y-4">
							...
							<div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/50 hover:border-primary/30 transition-colors">
								...
								<span className="font-semibold text-foreground">
									{prompt.views_count.toLocaleString()}
								</span>
							</div>
							...
							<div className="flex items-center justify-between p-3 rounded-lg bg-muted/30 border border-border/50 hover:border-primary/30 transition-colors">
								...
								<span className="font-semibold text-foreground">
									{prompt.copies_count.toLocaleString()}
								</span>
							</div>
